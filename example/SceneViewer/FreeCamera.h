...
// Pure input-driven transform mutation, no gameplay state. The viewer binds one
// to the active camera so any cooked scene is viewable even when it carries no
// camera of its own.
struct FreeCamera
{
    EntityId Entity;
