...
{
public:
    ArenaSessionPolicy(Engine& engine, Logger& log);
    ~ArenaSessionPolicy();

    ArenaSessionPolicy(const ArenaSessionPolicy&) = delete;
    ArenaSessionPolicy& operator=(const ArenaSessionPolicy&) = delete;
    ...
    [[nodiscard]] const CompiledArenaSettings* GameSettings();
