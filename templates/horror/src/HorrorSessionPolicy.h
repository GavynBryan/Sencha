...
//=============================================================================
class HorrorSessionPolicy
{
public:
    HorrorSessionPolicy(Engine& engine, Logger& log);
    ~HorrorSessionPolicy();

    HorrorSessionPolicy(const HorrorSessionPolicy&) = delete;
    HorrorSessionPolicy& operator=(const HorrorSessionPolicy&) = delete;
    ...
    [[nodiscard]] const CompiledHorrorSettings* GameSettings();
