...
namespace
{
    ...
    // The baked static direct diffuse radiance at one world-space surface
    // point: the same wrap-Lambert + windowed inverse-square model as the
    // forward shader (lighting.glsli), with one occlusion ray per light.
