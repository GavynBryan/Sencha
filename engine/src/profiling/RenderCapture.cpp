...
namespace
{
	...
	std::vector<FrameFields> BuildFrameFields(const RenderCapture::FrameRecord& record)
	{
		...
		std::vector<FrameFields> fields{
			...
			{ "projected_casters_gathered_count", static_cast<double>(stats.ProjectedCastersGathered) },
			{ "projected_casters_rendered_count", static_cast<double>(stats.ProjectedCastersRendered) },
			{ "projected_casters_dropped_count", static_cast<double>(stats.ProjectedCastersDropped) },
			{ "projected_receiver_draw_count", static_cast<double>(stats.ProjectedReceiverDraws) },
			...
			{ "shadow_instance_runs_count", static_cast<double>(stats.ShadowInstanceRuns) },
