...
namespace
{
	...
	std::vector<FrameFields> BuildFrameFields(const RenderCapture::FrameRecord& record)
	{
		...
		std::vector<FrameFields> fields{
			...
			{ "ui_draw_calls_count", static_cast<double>(stats.UiDrawCalls) },
			{ "ui_triangles_count", static_cast<double>(stats.UiTriangles) },
			{ "ui_texture_uploads_count", static_cast<double>(stats.UiTextureUploads) },
			{ "ui_texture_upload_bytes", static_cast<double>(stats.UiTextureUploadBytes) },
