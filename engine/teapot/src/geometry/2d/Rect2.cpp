...
{
	return Size.Data[0] >= 0.0f && Size.Data[1] >= 0.0f;
}
...
float Rect2::Width() const { return Size.Data[0]; }
float Rect2::Height() const { return Size.Data[1]; }
float Rect2::Area() const { return Size.Data[0] * Size.Data[1]; }
