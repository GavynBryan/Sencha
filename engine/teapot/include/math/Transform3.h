...
struct Transform3
{
	static_assert(std::is_arithmetic_v<T>, "Transform3 component type must be arithmetic.");
	...
	constexpr Transform3(const Vec<3, T>& position, const Quat<T>& rotation, const Vec<3, T>& scale)
